...
import seederData from "./restaurants.seeder.json";
...
const RestaurantsSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(RestaurantsSeederDialogComponent);
