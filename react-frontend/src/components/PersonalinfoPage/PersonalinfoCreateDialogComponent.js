    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="personalinfo-create-dialog-component">
                ...
                <div>
                    <p className="m-0" >Surname Name:</p>
                ...
                <div>
                    <p className="m-0" >Group ID:</p>
                    <InputText type="number" className="w-full mb-3" value={_entity?.groupID} onChange={(e) => setValByKey("groupID", e.target.value)}  />
                </div>
                <div>
